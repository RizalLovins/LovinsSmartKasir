...
import com.rizal.lovins.smartkasir.fragment.HomeAdminFragment;
import com.rizal.lovins.smartkasir.fragment.ProductFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.konten, new HomeAdminFragment()).commit();
    ...
    private void navigationDrawerMenu(MenuItem menu) {
        ...
        switch (menu.getItemId()) {
            case R.id.frag1:
                fragclass = HomeAdminFragment.class;
                break;
            case R.id.frag2:
    ...
    private void menuLogout() {
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                PreferenceUtil.logout(MainActivity.this);
